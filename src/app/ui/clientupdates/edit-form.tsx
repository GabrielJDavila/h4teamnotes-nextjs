...
export default function Form({clientupdate}: {clientupdate: Notes}) {
    ...
    const [year, month, day] = clientupdate.date.split("-")
                    ...
                    <div className="relative flex flex-col">
                        <label htmlFor="user" className="mb-2 block text-sm font-medium">
                            ...
                            <input
                                ...
                                name="user"
                                type="text"
                                defaultValue={session?.user?.name || clientupdate.username}
                    ...
                    <div className="relative flex flex-col">
                        <label htmlFor="date" className="mb-2 block text-sm font-medium">
                            ...
                            <input
                                ...
                                name="date"
                                type="date"
                                defaultValue={clientupdate.date}
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                                aria-describedby="add-client-error"
                            />
                    </div>
                    ...
                    <div className="flex">
                        <div className="relative w-full">
                            <textarea
                                id="note"
                                name="note"
                                defaultValue={clientupdate.note}
